...
const double HOME_LAT = -23.649689;                          // Enter Your Latitude and Longitude here
const double HOME_LNG = -47.167969;                         // to track how far away the "Dog" is away from Home 

/************************* Dados WiFi *********************************/

#define WLAN_SSID       "Selma2"                          // Enter Your router SSID
#define WLAN_PASS       "nina@001"                        // Enter Your router Password

/************************* Dados Adafruit.io *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                                // use 8883 for SSL
#define AIO_USERNAME    "Saraiva_"                          // Enter Your Adafruit IO Username
#define AIO_KEY         "aio_FmIh636Q5WIm8SptOEvohL5r2EX6"  // Enter Your Adafruit IO Key


/************ Global State (you don't need to change this!) ******************/


/***************** Comunicação entre o código e o MQTT Server ******************/
